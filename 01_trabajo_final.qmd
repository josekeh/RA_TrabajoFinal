...
Para el primer caso se busca obtener un modelo de regresión en el que las variables a utilizar se definan por el proceso automático de Stepwise regression. Para el análisis se quitan del dataset el nombre de la jugadora y el equipo. \[...\]
...
Ya con el Modelo 1 elegido, se procede a evaluar residuos.
